          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown" v-if="!mentorLoggedIn && !menteeLoggedIn">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownSignUp">
                <li>
                  <router-link class="dropdown-item" to="/mentor-register">As Mentor</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/mentee-register">As Mentee</router-link>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown" v-if="!mentorLoggedIn && !menteeLoggedIn">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownLogin">
                <li>
                  <router-link class="dropdown-item" to="/mentor-login">As Mentor</router-link>
                </li>
                <li>
                  <router-link class="dropdown-item" to="/mentee-login">As Mentee</router-link>
                </li>
              </ul>
            </li>
          </ul>
